...
I also write backend and full-stack code. Not as a hobby, but because infrastructure decisions you can't defend at the application layer tend to be the wrong ones.
...
- 🧮 **[What does leaving Datadog actually cost?](https://marcusneves.dev)**. An open TCO calculator. Put in your own numbers; if the migration doesn't pay for itself, it says so.
- 💼 [LinkedIn](https://linkedin.com/in/mnevesti)
...
Também escrevo backend e full-stack. Não como hobby, mas porque decisão de infraestrutura que você não consegue defender na camada de aplicação costuma ser a decisão errada.
